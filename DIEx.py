...
# pyvenv
# ⇒pyvenvとは、pythonのバージョン管理が可能な仮想環境です。２系と３系で環境を切り替えたり、
...
# clear()とdelの違い
# ⇒clear()はリスト内の要素を空にし、delはオブジェクトを破棄する
...
# decimal型(固定小数)やfloat型(浮動小数)=========================
    #NG(Javaのように末尾にfを付けるとsyntaxError)
    #print(5.1f)
    #print(type(5.1f))
print(int(10.45))
print(float(10.45))
...
print(range(3))
# ⇒ range(0, 3) ※そのまま表示される + 引数が2つに増えている点に要注意